...
#include "stdlib.h"
#include "string.h"
#include "pair_lj1210rna_3bead.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
...
PairLj1210RNA_3Bead::PairLj1210RNA_3Bead(LAMMPS *lmp) : Pair(lmp) 
{
...
PairLj1210RNA_3Bead::~PairLj1210RNA_3Bead()
{
  if (allocated) {
...
void PairLj1210RNA_3Bead::compute(int eflag, int vflag)
{
...
void PairLj1210RNA_3Bead::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLj1210RNA_3Bead::settings(int narg, char **arg)
{
...
void PairLj1210RNA_3Bead::coeff(int narg, char **arg)
{
...
double PairLj1210RNA_3Bead::init_one(int i, int j)
{
...
void PairLj1210RNA_3Bead::write_restart(FILE *fp)
{
...
void PairLj1210RNA_3Bead::read_restart(FILE *fp)
{
...
void PairLj1210RNA_3Bead::write_restart_settings(FILE *fp)
{
...
void PairLj1210RNA_3Bead::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairLj1210RNA_3Bead::single(int i, int j, int itype, int jtype,
