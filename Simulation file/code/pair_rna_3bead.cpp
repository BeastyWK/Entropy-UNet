...
PairRNA_3Bead::PairRNA_3Bead(LAMMPS *lmp) : Pair(lmp) 
{
...
void PairRNA_3Bead::compute(int eflag, int vflag)
{
...
void PairRNA_3Bead::settings(int narg, char **arg)
{
...
void PairRNA_3Bead::coeff(int narg, char **arg)
{
...
double PairRNA_3Bead::init_one(int i, int j)
{
...
void PairRNA_3Bead::write_restart(FILE *fp)
{
...
void PairRNA_3Bead::read_restart(FILE *fp)
{
...
void PairRNA_3Bead::write_restart_settings(FILE *fp)
{
...
void PairRNA_3Bead::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairRNA_3Bead::single(int i, int j, int itype, int jtype,
